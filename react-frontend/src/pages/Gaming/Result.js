              ...
              <div className="modal-content">
                ...
                <div className="form-bottom">
                  ...
                  <div className="result-btn-group">
                    <div className="row">
                      <Link to={'/map/'+(parseInt(this.props.mapID, 10) + 1)} ><button disabled={this.props.userType !== "game" || isNaN(parseInt(this.props.mapID, 10)) || (parseInt(this.props.mapID, 10) + 1) === 311} type="button" className="btn btn-success result-btn col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1" >下一关</button></Link>
                    </div>
                    <div className="row">
